...
if ( has_nav_menu( 'mobile' ) ) {
	...
	function samovar_show_mobile_menu() {
		echo '<div class="overlay overlay-hugeinc overlay-menu"><svg class="overlay-close" viewBox="0 0 32 32"><path d="M6.1,8.9l17,17c0.8,0.8,2,0.8,2.8,0c0.8-0.8,0.8-2,0-2.8l-17-17c-0.8-0.8-2-0.8-2.8,0S5.3,8.1,6.1,8.9z"/><path d="M23.1,6.1l-17,17c-0.8,0.8-0.8,2,0,2.8c0.8,0.8,2,0.8,2.8,0l17-17c0.8-0.8,0.8-2,0-2.8 C25.1,5.3,23.9,5.3,23.1,6.1z"/></svg>';
		$class = 'mobile-menu';
		genesis_nav_menu(
			array(
	...
	add_action( 'genesis_header', 'samovar_show_mobile_menu_trigger', 11 );
	function samovar_show_mobile_menu_trigger() {
		echo '<svg id="menu-trigger-overlay" viewBox="0 0 32 32"><path d="M4,10h24c1.1,0,2-0.9,2-2s-0.9-2-2-2H4C2.9,6,2,6.9,2,8S2.9,10,4,10z M28,14H4c-1.1,0-2,0.9-2,2s0.9,2,2,2h24c1.1,0,2-0.9,2-2S29.1,14,28,14z M28,22H4c-1.1,0-2,0.9-2,2s0.9,2,2,2h24c1.1,0,2-0.9,2-2S29.1,22,28,22z"/></svg>';
	}
